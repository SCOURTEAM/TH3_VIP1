...
if database:get("lock_link:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_username:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_chat:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_sarha:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_tag:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_bot:TH3_VIP1"..msg.chat_id_..bot_id) then

changeChatMemberStatus(msg.chat_id_, msg.content_.members_[0].id_, "Kicked")

end

if database:get("lock_botAndBan:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_fwd:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_stecker:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_new:TH3_VIP1"..msg.chat_id_..bot_id) then
...
database:incr( TH3_VIP1: ..bot_id.. user:add ..msg.chat_id_.. : ..msg.sender_user_id_)

end

if msg.content_.ID == "MessageUnsupported" then

if database:get("lock_note:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_photo:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:get("lock_audeo:TH3_VIP1"..msg.chat_id_..bot_id) then
...
if database:ge("lock_files:tshake"..msg.chat_id_..bot_id) then
...
keko3 = math.random(#keko_text)
  ...
  local tshake_new_text = TH3_VIP1_new_text:gsub( #stast ,(t or  لا يوجد ))   

  send(msg.chat_id_, msg.id_, 1, TH3_VIP1_new_text, 1,  html )
  ...
  if not database:get( TH3_VIP1: ..bot_id.. id:mute ..msg.chat_id_) then

  if not database:get( TH3_VIP1: ..bot_id.. id:photo ..msg.chat_id_) then

  if not database:get("TH3_VIP1:gr:id:text:"..bot_id..msg.chat_id_) then 
  ...
  local tshake_new_text = TH3_VIP1_new_text:gsub( #username ,(keko_info or  لا يوجد ))

  local tshake_new_text = TH3_VIP1_new_text:gsub( #id ,(msg.sender_user_id_ or  لا يوجد ))

  local tshake_new_text = TH3_VIP1_new_text:gsub( #edit ,(edit or  لا يوجد ))

  local tshake_new_text = TH3_VIP1_new_text:gsub( #msgs ,(user_msgs or  لا يوجد ))
  ...
  local TH3_VIP1_new_text = database:get("tshake:gr:id:text:"..bot_id..msg.chat_id_)
  ...
  if  (text and text ==  تفعيل التثبيت ) and is_owner(msg) then
     ...
     if not database:get( TH3_VIP1: ..bot_id.. pin:mute ..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1,  ☑┇تم تفعيل التثبيت , 1,  md )
    ...
    database:del( TH3_VIP1: ..bot_id.. pin:mute ..msg.chat_id_)
   ...
   if  (text and text ==  تعطيل التثبيت ) and is_owner(msg) then
     ...
     if database:get( TH3_VIP1: ..bot_id.. pin:mute ..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1,  ☑┇تم تعطيل التثبيت , 1,  md )
     ...
     database:set( TH3_VIP1: ..bot_id.. pin:mute ..msg.chat_id_,true)
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
  ...
  👋┇اهلا بك في سورس رايدم 

    

  🌐┇<strong>SCOUR TEAM</strong>

    

  🦁┇<a href="https://telegram.me/VI_P2">قناه السورس</a>

  📜┇<a href="https://telegram.me/VI_P2">قناه شروحات سورس</a>

  📁┇<a href="https://telegram.me/VI_P2">قناه ملفات السورس</a>

    

  🔎┇<a href="https://t.me/VI_P2/227">طريقه التنصيب</a>
...
local Data_TH3_VIP1 = data

--         »»                 Run TH3_VIP1                         ««              --

if database:get( TH3_VIP1: ..bot_id.."charge:"..msg.chat_id_) then
